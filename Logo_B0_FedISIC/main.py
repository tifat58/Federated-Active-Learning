...
def get_dataset(args):
    ...
    # medical benchmarks
        ...
        from data.fedisic_loader import load_csv_splits, get_fedisic_loaders
...
if __name__ == '__main__':
    ...
    with open("/home/student_account/Desktop/Aditya/Logo_B0_FedISIC/save/fedavg/fedisic/logs/runtime_log.txt", "a") as f:
