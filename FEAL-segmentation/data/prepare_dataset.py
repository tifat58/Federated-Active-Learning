...
def prepare_polyp():
    ...
    for i, site_name in enumerate(client_name):
        client_data_list.append(sorted(glob('/home/student_account/Desktop/Aditya/FEAL-Segmentation/Dataset/FedPolyp/{}/image/*'.format(site_name))))
        client_mask_list.append(sorted(glob('/home/student_account/Desktop/Aditya/FEAL-Segmentation/Dataset/FedPolyp/{}/mask/*'.format(site_name))))

    for client_idx in range(len(client_name)):
        if not os.path.exists('/home/student_account/Desktop/Aditya/FEAL-Segmentation/Dataset/FedPolyp_npy/client{}'.format(client_idx+1)):
            os.makedirs('/home/student_account/Desktop/Aditya/FEAL-Segmentation/Dataset/FedPolyp_npy/client{}'.format(client_idx+1))
        ...
        for data_idx in range(len(client_data_list[client_idx])):
            ...
            np.save('/home/student_account/Desktop/Aditya/FEAL-Segmentation/Dataset/FedPolyp_npy/client{}/sample{}.npy'.format(client_idx+1, data_idx+1), sample)
